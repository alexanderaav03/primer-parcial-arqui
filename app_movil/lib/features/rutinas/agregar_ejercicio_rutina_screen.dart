...
class AgregarEjercicioRutinaScreen extends ConsumerStatefulWidget {
  ...
  const AgregarEjercicioRutinaScreen({super.key, required this.rutinaId, required this.clienteId});

  @override
  ConsumerState<AgregarEjercicioRutinaScreen> createState() => _AgregarEjercicioRutinaScreenState();
}

class _AgregarEjercicioRutinaScreenState extends ConsumerState<AgregarEjercicioRutinaScreen> {
  ...
  Future<void> _agregar() async {
    ...
    try {
      ...
      setState(() {
        _agregados.add(_DetalleAgregadoUI(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ejerciciosAsync.when(
        loading: () => const LoadingView(message: 'Cargando banco de ejercicios...'),
                ...
                child: Padding(
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text('Agregar ejercicio', style: Theme.of(context).textTheme.titleMedium),
                ...
                for (final item in _agregados) ...[
                  Card(
                    child: ListTile(
                      ...
                      subtitle: Text('${item.series} series x ${item.repeticiones} reps'),
                    ),
                  ),
                  const SizedBox(height: 8),
                ],
